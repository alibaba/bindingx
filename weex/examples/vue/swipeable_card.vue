	...
	module.exports = {
      ...
      opacity: 1
        ...
        var gesTokenObj = Binding.bind({
          ...
          props: [
            {
              element: my, property: 'transform.translateX',
              expression: translate_x_origin
            },
            {
              element: my, property: 'opacity',
        ...
        var result = Binding.bind({
          ...
          props: [
            {element: my, property: 'transform.translateX', expression: translate_x_origin},
            {element: my, property: 'opacity', expression: opacity_origin}
          ]
